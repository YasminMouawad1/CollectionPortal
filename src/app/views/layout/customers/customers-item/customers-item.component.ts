...
console.log(this.allContractImages)
    ...
    if(res.data.userDocuments.length > 0){
      ...
      if(res.data.userDocuments[0].activatorDetails != null){
        ...
        this.uploadedDate = res.data.userDocuments[0].activatorDetails.uploadedDate;
      }
    }
  ...
  showImg(index: number) {
    ...
    if(this.allContractImages[index].activatorDetails != null){
      ...
      this.uploadedDate =  this.allContractImages[index].activatorDetails.uploadedDate;
    }else{
      this.locationName = 'N/A';
      this.mobileNum = 'N/A';
      this.name = 'N/A';
      this.uploadedDate = 'N/A'
    }
